...
public class FourthServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Name name1 = new Name("Nguyen", "Huy");
        Name name2 = new Name("Nguyen", "Nam");
        Name name3 = new Name("Tran", "Hung");

        Address address1 = new Address("Nam Dan", "Nghe An", "36");
        Address address2 = new Address("Soc Son", "Ha Noi", "20");
        Address address3 = new Address("Dong Anh", "Ha Noi", "20");
